...
class CustomerControllerTest {
    ...
    fun `should create customer`() {
        val request = PostCustomerRequest("fake name", "${Random.nextInt()}", "123456")
        mockMvc.perform(
            post("/customers")
    ...
    fun `should throw error when create customer has invalid information`() {
        val request = PutCustomerRequest("", "${Random.nextInt()}", "123456")
    ...
    fun `should update customer`() {
        val customer = customerRepository.save(buildCustomer())
        val request = PutCustomerRequest("Gustavo", "emailupdate@email.com", "123456")
    ...
    @Test
    fun `should return not found update customer not existing`() {
        val request = PutCustomerRequest("Gustavo", "emailupdate@email.com", "123456")
